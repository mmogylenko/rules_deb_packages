...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@mmogylenko_rules_deb_packages//deb:toolchain_type"]
    return [
        toolchain_info,
        toolchain_info.default,
        toolchain_info.debinfo,
...
resolved_toolchain = rule(
    ...
    toolchains = ["@mmogylenko_rules_deb_packages//deb:toolchain_type"],
...
# By default all these toolchains are registered by the deb_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:deb_toolchain",
    toolchain_type = "@mmogylenko_rules_deb_packages//deb:toolchain_type",
)
""".format(
            platform = platform,

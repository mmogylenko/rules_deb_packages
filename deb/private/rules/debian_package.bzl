"""
Debian package repository rules.
"""
BUILD_TMPL = """\
# GENERATED BY debian_archive.bzl
load("@rules_deb_packages//deb/private/rules/pkg:dpkg_status.bzl", "dpkg_status")
load("@rules_deb_packages//deb/private/rules/pkg:debian_spdx.bzl", "debian_spdx")
load("@rules_deb_packages//deb/private/rules/util:merge_providers.bzl", "merge_providers")
...
_debian_package = repository_rule(
    implementation = _debian_package_impl,
    attrs = _attrs,
)

def debian_package(name, **kwargs):
    _debian_sources(name = "{}_sources".format(name), **kwargs)
    _debian_package(name = name, **kwargs)
